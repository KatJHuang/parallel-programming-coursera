...
public final class ReciprocalArraySum {
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        /**
         * Number of elements to stop division at.
         */
        protected final static int sThreshold = 8_000;
        ...
        protected void compute() {
            if (endIndexExclusive - startIndexInclusive < sThreshold){
                computeDirectly();
                return;
            }
            ...
            ReciprocalArraySumTask left = new ReciprocalArraySumTask(startIndexInclusive,
                    midIndex,
                    input);
            ReciprocalArraySumTask right = new ReciprocalArraySumTask(midIndex,
                    endIndexExclusive,
                    input);
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        for (int i = 0; i < numTasks; i++) {
            ReciprocalArraySumTask task = new ReciprocalArraySumTask(getChunkStartInclusive(i, numTasks, input.length),
                    getChunkEndExclusive(i, numTasks, input.length),
                    input);
            task.fork();
            reciprocalArraySumTasks.add(task);
        }
